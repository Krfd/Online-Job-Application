    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>System Analyst | <?php echo $analyst; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    System analysts are responsible for analyzing and
                    evaluating the needs of a business and then designing,
                    building, and implementing information systems to meet
                    those needs. They work with a variety of computer
                    systems and software applications to help businesses
                    improve their efficiency and productivity.
                </p>
                <br>
                <h3>Qualifications</h3>
                <ul>
                    <li>Bachelor's degree in computer scienceor information technology, or equivalent experience</li>
                    <li>Excellent analytical skills</li>
                    <li>Working knowledge of a wide variet of programming languages</li>
                    <li>Strong computer, hardware, software, and analytical skills</li>
                    <li>Proven ability to assess business needs and translate them into relevant solutions</li>
                    <li>Experience installing, configuring, documenting, testing, training, and implementing new applications and systems</li>
                </ul>
            </div>
            <div class="container position">
