...
if($check) {
    while($row = mysqli_fetch_array($check)) {
        ...
        if(isset($_POST['update'])) {
            ...
            $update = ("UPDATE registration SET firstname = '$firstname', lastname = '$lastname', email = '$email', address = '$address' WHERE id = $id");
...
<head>
    ...
    <title>Updating Registration Information</title>
