    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>UI/UX Designer | <?php echo $designer; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    A UX Designer, or User Experience Designer, is responsible for monitoring user experience and ensuring that websites, software programs and products are easy to use. 
                    Their duties include reviewing user feedback to determine potential defects or areas for clarity, working closely with other IT professionals and company personnel to refine user experience and performing usability tests on software products or website features to ensure functionality.
                </p>
                <br>
                ...
                <ul>
                    ...
                    <li>Excellent interpersonal and communication skills to communicate ideas to developers</li>
                    <li>Knowledge of industry tools like Adobe, Zeplin, OmniGraffle, Illustrator and Sketch</li>
                    <li>Problem-solving skills to determine solutions to user interface challenges</li>
                    <li>Multi-tasking and time management skills, with the ability to prioritize tasks</li>
                    <li>Analytical mind with business acumen</li>
                    <li>Ability to work both independently and in a team</li>
                    <li>Attention to detail and mastery of information design</li>
                </ul>
            </div>
            <div class="container position">
