    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Network Architect | <?php echo $architect; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    A network architect is a valuable professional in the information technology field. 
                    Working in information technology, especially in jobs that involve computer networking or programming, can offer creative work opportunities and competitive pay. 
                    You might thrive as a network architect if you have a background in information technology and an interest in designing new computer networks. 
                    In this article, we explore what working as a network architect can be like and learn how to start a career as a network architect.
                </p>
                <br>
                ...
                <ul>
                    ...
                    <li>Possess organizational skills</li>
