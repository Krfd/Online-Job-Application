    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>IT Director | <?php echo $director; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    The IT Director is responsible for the overall management of the IT department. 
                    This includes the development and implementation of the company's information technology strategy, as well as the management of the department's budget and resources. 
                    The IT Director is also responsible for the development and implementation of the company's IT policies and procedures.
                </p>
                <br>
                ...
                <ul>
                    ...
                    <li>Ability to lead and teach others </li>
                    <li>Up-to-date knowledge of latest IT developments</li>
                    <li>Ability to explain highly technical concepts in simple terms</li>
                    <li>Knowledge of best computer security practices</li>
                    <li>Good research and analysis skills</li>
                </ul>
            </div>
            <div class="container position">
                ...
                <div class="container apply">
                    <div class="content">
                        ...
                        <p>
                            ...
                            possessed. In this matter, the <Pspan class="highlight">Company</Pspan> encourage
