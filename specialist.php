    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Support Specialist | <?php echo $specialist; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    The support specialist is responsible for providing technical
                    support to users. They will be responsible for installing,
                    configuring, and maintaining computer systems and networks
                    as well as diagnosing hardware and software faults and
                    solving technical and applications problems, either over the
                    phone or in person. They will also provide support, including
                    procedural documentation and relevant reports. The support
                    specialist will also be responsible for supporting the roll
                    out of new applications. They will be required to work
                    closely with other members of the IT team.
                </p>
                <br>
                ...
                <ul>
                    ...
                    <li>Comfortable working in and assisting others through company help desk software, such as Zendesk in addition to other remote access desktop programs</li>
