...
<html lang="en">
    <head>
        ...
        <link type="icon" rel="icon" href="background/Information Technology.png Solutions.png" />
    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Network Engineer | <?php echo $network; ?> slots</h2>
                <br>
                ...
                <ul>
                    <li>Comprehensive understanding of network services and networks such as TCP/IP, OSPF and EIGRP</li>
                    <li>In-depth understanding and  practical knowledge of networking sytems such as LAN, firewalls, routers and printers</li>
                    <li>Ability to analyze and evaluate networks, identify issues and provide solutions to ensure networks are operating efficiently</li>
                    <li>Ability to design, implement and troubleshoot Wi-FI and security infrastructure</li>
                    <li>Time management</li>
                    <li>Ability to manage several projects simultaneously from design to implementation</li>
                    <li>Ability to communicate technical information to other technical team members but also to coworkers in other departments who may not have knowledge of networking technical terminology</li>
                </ul>
            </div>
            <div class="container position">
