    ...
    if($validate) {
        while($row = mysqli_fetch_array($validate)) {
            ...
            if(isset($_POST['update'])) {
                ...
                $update = ("UPDATE web SET firstname = '$firstname', lastname = '$lastname', email = '$email', contact = '$contact', city = '$city', address = '$address' WHERE id = $id");
...
<body>
    <div class="container my-5">
        ...
        <div class="col">
            <img src="<?php echo "developer/resume/".$resume; ?>" alt="A document file" class="resume">
        </div>
        </div>
    </div>
</body>
