    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Computer Programmer | <?php echo $programmer; ?> slots</h2>
                <br>
                ...
                <ul>
                    <li>Strong attention to detail and ability to spot tiny errors or inconsistencies in code</li>
                    <li>Must have excellent creative problem solving skills</li>
                    <li>Excellent communication skills and ability to work with a team</li>
                    <li>Knowledge of programming languages such as Python, Java, JavaScript, C++, Ruby on Rails, and more</li>
                    <li>Up to date on the latest software innovations and committed to continually building on existing knowledge and skills</li>
                    <li>Exemplify superior time management skills and capable of working productively with minimal supervision</li>
                    <li>Ability to follow directions closely and accurately</li>
                    <li>A desire to innovate and create cutting edge programs</li>
                </ul>
            </div>
            <div class="container position">
