    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Information Security | <?php echo $security; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    Information security analysts are responsible for
                    protecting an organization's computer networks and
                    systems. Their responsibilities include planning and
                    carrying out security measures to protect an
                    organization's computer networks and systems. They
                    also ensure that all security and data protection
                    policies are up-to-date and followed by employees.
                </p>
                <br>
                <h3>Qualifications</h3>
                <ul>
                    <li>Network security management skills</li>
                    <li>Security risk management skills</li>
