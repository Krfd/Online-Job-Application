        ...
        <div class="container-fluid main">
            ...
            if($result) {
                while($row = mysqli_fetch_array($result)) {
                    $scientist = $row['comsci'];
                }
            }

            ?>
            <div class="container position">
                <h2>Computer Scientist | <?php echo $scientist; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    The Computer Scientist is responsible for designing, implementing and maintaining the company's computer networks. The Computer Scientist will also be responsible for designing and implementing the company's Wi-Fi and security infrastructure. 
                    The Computer Scientist will also be responsible for maintaining the company's computer systems and ensuring that they are operating efficiently. 
                </p>
                <br>
                <h3>Qualifications</h3>
                <ul>
                    <li>Bachelors degree holder or undergraduate with at least 2 years of relevant experience</li>
                    <li>Demonstrated experience developing and deploying ML models</li>
                    <li>Python proficiency</li>
                    <li>Experience visualizing/presenting data for stakeholders</li>
                    <li>Experience with OCR, NER, and other NLP techniques</li>
                    <li>Experience with at least one common deep learning library (TF, Keras, Pytorch)</li>
                    <li>Excellent written and verbal communication skills</li>
                    <li>Experience deploying machine learning models in production</li>
                </ul>
            </div>
            <div class="container position">
