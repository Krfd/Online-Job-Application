...
$id = $_GET['updateid'];
$sql = "SELECT * FROM bootcamp WHERE id = $id";
...
if($check) {
    while($row = mysqli_fetch_array($check)) {
        ...
        if(isset($_POST['update'])) {
            ...
            $update = ("UPDATE bootcamp SET first_name = '$firstname', last_name = '$lastname', middle_name = '$middlename', age = '$age', birthdate = '$birthday', phone = '$contact',  address = '$address', email = '$email' WHERE id = $id");
...
<body>
    <div class="container my-5">
        <h2>Update Bootcamp Enrollment</h2>
        <form method="post">
            <fieldset>
                <div class="row">
                    <div class="col">
