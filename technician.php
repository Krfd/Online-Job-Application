    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>IT Technician | <?php echo $technician; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    IT technicians are responsible for installing, maintaining and
                    repairing computer systems and networks. They are also
                    responsible for diagnosing and solving hardware and software
                    faults. They may also be involved in the design of computer
                    systems.
                </p>
                <br>
                <h3>Qualifications</h3>
                <ul>
                    <li>Bachelor's degree in computer science or engineering or related field, preferred</li>
                    <li>A+ and Linux+ Certification, required</li>
                    <li>Experience troubleshooting systems</li>
                    <li>Skilled in database programming and software installation</li>
                    <li>Excellent written and oral communication skills</li>
                    <li>Familiar with a range of software and hardware</li>
                </ul>
            </div>
            <div class="container position">
