...
if(isset($_GET['updateid'])) {
    $id = $_GET['updateid'];
    $sql = "SELECT * FROM it_security WHERE id = $id";
    ...
    if($validate) {
        while($row = mysqli_fetch_array($validate)) {
            ...
            if(isset($_POST['update'])) {
                ...
                $update = ("UPDATE it_security SET firstname = '$firstname', lastname = '$lastname', email = '$email', contact = '$contact', city = '$city', address = '$address' WHERE id = $id");
...
<body>
    <div class="container my-5">
        ...
        <div class="col">
            <img src="<?php echo "it_security/resume/".$resume; ?>" alt="A document file" class="resume">
        </div>
        </div>
    </div>
</body>
