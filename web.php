    ...
    <body>
        <div class="container-fluid main">
            ...
            <div class="container position">
                <h2>Web Developer | <?php echo $web; ?> slots</h2>
                <br>
                <h3>Job Description</h3>
                <p>
                    Web developers are responsible for creating and maintaining websites. They are
                    responsible for the technical aspects of a website, including its performance
                    and capacity, which are measures of a website's speed and how much traffic the
                    site can handle. They are also responsible for the site's design, which is how
                    it looks and functions. Web developers work with a variety of programming
                    languages, such as HTML, CSS, JavaScript, PHP, and ASP.NET, to create
                    functional websites.
                </p>
                <br>
                ...
                <ul>
                    ...
                    <li>Understanding of search engine optimization (SEO) practices </li>
                    ...
                    <li>Ability to troubleshoot and optimize web pages for security and responsiveness</li>
                    <li>Understanding of network diagnostics and analytical tools</li>
                </ul>
            </div>
            <div class="container position">
